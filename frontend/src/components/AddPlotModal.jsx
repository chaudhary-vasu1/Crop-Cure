...
const AddPlotModal = ({ isOpen, onClose, onPlotAdded }) => {
    ...
    return createPortal(
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 dark:bg-black/75 backdrop-blur-md animate-fade-in">
            <div className="w-full max-w-md max-h-[85vh] overflow-y-auto scrollbar-thin p-6 sm:p-8 bg-white dark:bg-gray-900 border border-slate-200/50 dark:border-gray-800/50 rounded-3xl shadow-2xl animate-scale-in text-left">
